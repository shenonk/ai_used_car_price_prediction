  ...
  const marketUpdates = [
    {
      ...
      text: "Vehicle prices in Colombo increased by 5% this month",
      tag: "trending"
    },
    {
      icon: (
      ...
      text: "Hybrid vehicles demand rising rapidly",
      tag: "hot"
    },
    {
      icon: (
      ...
      text: "Bank loan interest reduced by 0.5%",
      tag: "finance"
    },
    {
      icon: (
  ...
  const activities = [
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M8 17h8M8 17v-4m8 4v-4m-8 0h8m-8 0l-2-4h12l-2 4M6 13l-2-4h16l-2 4" />
        </svg>
      ),
      text: "New prediction generated — Toyota Aqua 2018",
      time: "2 min ago"
    },
    {
      icon: (
      ...
      text: "User downloaded price report",
      time: "15 min ago"
    },
    {
      icon: (
      ...
      text: "Loan calculation completed",
      time: "1 hour ago"
    },
    {
      icon: (
      ...
      text: "System accuracy updated to 87%",
      time: "3 hours ago"
    }
  ];
    ...
    <div className="min-h-screen bg-[#0f172a] p-8">
        ...
        <div className="card p-6 animate-fade-in animate-delay-400">
          ...
          <div className="space-y-4">
            {activities.map((activity, index) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 group-hover:scale-110 transition-transform duration-300">
                  {activity.icon}
                </div>
                <div className="flex-1">
      ...
      <div className="mt-8 p-6 rounded-2xl bg-gradient-to-r from-blue-600/20 to-cyan-600/20 border border-blue-500/20 animate-fade-in animate-delay-500">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button className="btn-gradient whitespace-nowrap flex items-center gap-2">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
